...
export default function sitemap(): MetadataRoute.Sitemap {
  const pages = [
    ...
    { url: `${BASE}/brillantringe`, priority: 0.9, changeFrequency: 'weekly' as const },
    { url: `${BASE}/goldankauf`, priority: 0.9, changeFrequency: 'weekly' as const },
    { url: `${BASE}/ringe`, priority: 0.8, changeFrequency: 'weekly' as const },
    { url: `${BASE}/kreuze`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${BASE}/ohrstecker`, priority: 0.8, changeFrequency: 'monthly' as const },
    { url: `${BASE}/creolen`, priority: 0.8, changeFrequency: 'monthly' as const },
