          ...
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              <a
                ...
                aria-label="KenJu Juwelier auf Instagram – @juwelier_kenju"
                className="w-8 h-8 flex items-center justify-center border border-kenju-border hover:border-kenju-gold/60 transition-colors"
              >
                <svg className="w-4 h-4 text-kenju-muted hover:text-kenju-gold" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="KenJu Juwelier auf Facebook – Juwelier KenJu Bielefeld"
                className="w-8 h-8 flex items-center justify-center border border-kenju-border hover:border-kenju-gold/60 transition-colors"
              >
                <svg className="w-4 h-4 text-kenju-muted hover:text-kenju-gold" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <a
                href="https://wa.me/4917663284312"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="KenJu Juwelier auf WhatsApp kontaktieren"
                className="w-8 h-8 flex items-center justify-center border border-kenju-border hover:border-kenju-gold/60 transition-colors"
              >
                <svg className="w-4 h-4 text-kenju-muted hover:text-kenju-gold" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
