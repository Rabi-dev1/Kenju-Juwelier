const reviews = [
  {
    ...
    initials: 'SM',
    rating: 5,
    text: 'Absolut beeindruckende Beratung und ein wunderschöner Verlobungsring. KenJu hat meine Erwartungen bei Weitem übertroffen – die Qualität ist unvergleichlich. Wir kommen definitiv wieder!',
  ...
  },
  {
    ...
    initials: 'AB',
    rating: 5,
    text: 'Ich habe nach dem perfekten Ehering gesucht und ihn bei KenJu gefunden. Die Beratung war geduldig, persönlich und das Ergebnis einfach traumhaft. Sehr empfehlenswert!',
  ...
  },
  {
    ...
    initials: 'LR',
    rating: 4,
    text: 'Sehr schöne Auswahl und freundliches Personal. Das Kreuz aus 18-karätigem Gold ist wirklich ein Schmuckstück. Lieferung hätte etwas schneller sein können, aber die Qualität stimmt absolut.',
    dateRelative: 'vor 6 Monaten',
    date: '2025-11-20',
    item: 'Goldkreuz 18K',
    verified: true,
  },
